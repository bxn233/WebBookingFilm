...
import HomeMenuGrChild from "./HomeMenuGrChild";
...
export default function HomeMenuChild(props) {
  const { rap } = props;
      ...
      >
        ...
        >
          <div className="flex justify-center mt-4  mb-3 relative ">
            ...
            />
            <SearchOutlined style={{fontSize: '22px', color: 'gray', position: 'absolute', right: 27, top: '19%', cursor:'pointer', padding: 5}} />
          </div>
            ...
            return (
              ...
              key={index}
                ...
                icon={
                  ...
                  >
                    <div
                      className="w-3/12 border-2 border-gray-200 flex items-center justify-center mr-5 rounded-xl overflow-hidden"
                      style={{ width: 50, height: 50 }}
                    >
                      <img
                        src={cumRap.hinhAnh}
                        className="rounded-lg object-center object-cover h-full"
        ...
        {rap.lstCumRap?.slice(0, 4).map((cumRap, index) => {
          ...
          return (
            <TabPanel value={index.toString()} key={index} style={{width: '67%', padding: 0}}>
              <div
                    className=" border-b-2 border-gray-200 group flex h-20 items-center text-left overflow-hidden px-2 "
                    key={index}
                    style={{
                      width: "100%",
                  ...
                  <div className="showPhim" style={{height: 450}}>
                      <HomeMenuGrChild danhSachPhim={cumRap.danhSachPhim} />
                  </div>
            </TabPanel>
          );
        })}
