    ...
    return <Route {...restProps} render={(propsRoute) => {
        return <Fragment>
            <section className="min-h-screen flex items-stretch text-white ">
                <div className="lg:flex w-1/2 hidden bg-no-repeat bg-cover relative items-center" style={{ backgroundImage: 'url(https://farm8.staticflickr.com/7895/44769886330_e8106192e0_o.jpg)' }}>
                    <div className="absolute bg-black opacity-60 inset-0 z-0" />
                    <div className="w-full px-24 z-10">
                        <h1 className="text-5xl font-bold text-left tracking-widest" style={{ color: 'rgb(192, 182, 135)' }}>MBO Cinemas</h1>
                        <p className="text-3xl my-4">Bookings, Reviews, and Where to watch the most movies in the world</p>
                    </div>
                ...
                <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style={{ backgroundColor: '#222' }}>
                    <div className="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" style={{ backgroundImage: 'url(https://farm8.staticflickr.com/7895/44769886330_e8106192e0_o.jpg)' }}>
                        <div className="absolute bg-black opacity-60 inset-0 z-0" />
                    </div>
                    <div className="w-full py-6 z-20">
                        <div className="flex items-center justify-center">
                            <img src='https://scontent.xx.fbcdn.net/v/t1.15752-9/278386001_1023995578242005_3548851327193131055_n.png?stp=dst-png_p206x206&_nc_cat=106&ccb=1-5&_nc_sid=aee45a&_nc_ohc=SWejTKIMQlMAX9gZIF2&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_AVIh47KWNuGtO7QwMiW2rCJVszAeeh7XuP-s3gZfOWzuWg&oe=6286AAFA' style={{ width: 160, color: 'white' }} alt='logoWeb' className='mr-4' />
                            <div className="px-12 space-x-2 border-l-2 border-gray-100 py-3 lg:block hidden">
